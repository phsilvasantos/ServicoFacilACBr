...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if not(fDMCadOS.fnc_Nota_Gerada(ceAno.AsInteger,ComboBox3.ItemIndex + 1,fDMCadOS.mExtratoNum_Contrato.AsInteger,fDMCadOS.mExtratoAno_Contrato.AsInteger,0))  then
          prc_Gravar_NFSe;
      end
      else
        prc_Gravar_NFSe;
