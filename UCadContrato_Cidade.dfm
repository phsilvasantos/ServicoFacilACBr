object frmCadContrato_Cidade: TfrmCadContrato_Cidade
  Left = 402
  Top = 201
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'frmCadContrato_Cidade'
  ClientHeight = 270
  ClientWidth = 741
  Color = clMoneyGreen
  ...
  object DBEdit1: TDBEdit
    ...
    Ctl3D = False
    DataField = 'ID_CIDADE'
    DataSource = DMCadOS.dsOS_Cidade
    ParentCtl3D = False
    TabOrder = 1
    OnExit = DBEdit1Exit
  end
  object RxDBLookupCombo1: TRxDBLookupCombo
    ...
    LookupField = 'ID'
    LookupDisplay = 'NOME'
    LookupSource = DMCadOS.dsCidade
    ParentCtl3D = False
    TabOrder = 2
    OnEnter = RxDBLookupCombo1Enter
  end
  object edtValorContrato: TDBEdit
    Left = 181
    Top = 36
    Width = 84
    Height = 19
  ...
  object edtDataValidade: TDBDateEdit
    Left = 181
    Top = 152
    Width = 121
    Height = 21
